...
public class Finger_userinfo_relation2 implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_relation2 newFinger_userinfo_relation2(long fur_id, long fu_id, String fu_nd, String fingerprint, String finger_veno, String fingerprint_hash, String finger_veno_hash, int is_del, java.util.Date ctime, java.util.Date utime, String note, String fingerprint_img, String finger_veno_img) {
    ...
    public void assignment(Finger_userinfo_relation2 finger_userinfo_relation2) {
        ...
        java.util.Date ctime = finger_userinfo_relation2.getCtime();
        java.util.Date utime = finger_userinfo_relation2.getUtime();
