...
public class Finger_userinfo_new2 implements Cloneable , Serializable{
    ...
    public static Finger_userinfo_new2 newFinger_userinfo_new2(long fu_id, String fu_nd, String ui_tel, long ui_id, String ui_nd, String name, String sfz_number, String sfz_img_url, String sfz_img_back_url, int state, int is_del, java.util.Date ctime, java.util.Date utime, String mac, long gather_id, String note, int fingerprint_state, int finger_veno_state) {
    ...
    public void assignment(Finger_userinfo_new2 finger_userinfo_new2) {
        ...
        java.util.Date ctime = finger_userinfo_new2.getCtime();
        java.util.Date utime = finger_userinfo_new2.getUtime();
