...
package com.park.mvc.action.v1.park;

import com.park.bean.ReturnDataNew;
import com.park.constants.Constants;
import com.park.mvc.service.OrderBiz;
...
public class Read_ParkInfoAction extends BaseV1Controller {
   ...
   * 读取停车场详情
   */
  @RequestMapping(value = "/read_park_info")
  @ResponseBody
  public String read_park_info(HttpServletResponse response, Param_park_info param) {
    ...
    try {
      ...
      orderBiz.read_park_info(returnData, param.dtype, param.pi_id, param.area_code);
      sendResp(returnData, response);
      return null;

    } catch (Exception e) {
      log.error("Read_ParkInfoAction.read_park_info is error  2.21	Read-读取停车场详情 (APPSDK-JAVA)- P",
          e);
