...
@Repository("finger_userinfo_new2Dao")
public class Finger_userinfo_new2Dao extends BaseDao{

    Logger log = LoggerFactory.getLogger(Finger_userinfo_new2Dao.class);



    private  String TABLE = "finger_userinfo_new2";

    private  String TABLENAME = "finger_userinfo_new2";
    ...
    //添加数据
    public int insert(Finger_userinfo_new2 bean) throws SQLException{
        return insert(bean, TABLENAME);
    }

    //添加数据
    public int insert(Finger_userinfo_new2 bean, String TABLENAME2) throws SQLException{
        String sql;
        try{
    ...
    //添加数据
    public int insert_primarykey(Finger_userinfo_new2 bean) throws SQLException{
        return insert_primarykey(bean, TABLENAME);
    }

    //添加数据
    public int insert_primarykey(Finger_userinfo_new2 bean, String TABLENAME2) throws SQLException{
        String sql;
        try{
    ...
    //批量添加数据
    public int[] insert(List<Finger_userinfo_new2> beans) throws SQLException{
        return insert(beans, TABLENAME);
    }

    //批量添加数据
    public int[] insert(final List<Finger_userinfo_new2> beans, String TABLENAME2) throws SQLException{
        String sql;
        try{
            ...
            return _np.getJdbcOperations().batchUpdate(sql, new BatchPreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps, int i) throws SQLException {
                    Finger_userinfo_new2 bean = beans.get(i);
    ...
    //查询所有数据
    public List<Finger_userinfo_new2> selectAll() {
        return selectAll(TABLENAME);
    }

    //查询所有数据
    public List<Finger_userinfo_new2> selectAll(String TABLENAME2) {
        String sql;
        try{
            ...
            return _np.getJdbcOperations().query(sql, new BeanPropertyRowMapper<Finger_userinfo_new2>(Finger_userinfo_new2.class));
        }catch(Exception e){
            //createTable(TABLENAME2);
            log.error("selectAll", e);
            return new ArrayList<Finger_userinfo_new2>();
        }
    }

    //查询最新数据
    public List<Finger_userinfo_new2> selectLast(int num) {
        return selectLast(num, TABLENAME);
    }

    //查询所有数据
    public List<Finger_userinfo_new2> selectLast(int num ,String TABLENAME2) {
        String sql;
        try{
    ...
    //根据主键查询
    public List<Finger_userinfo_new2> selectGtKey(long fu_id) {
        return selectGtKey(fu_id, TABLENAME);
    }

    //根据主键查询
    public List<Finger_userinfo_new2> selectGtKey(long fu_id, String TABLENAME2) {
        String sql;
        try{
            ...
            return _np.query(sql, param, new BeanPropertyRowMapper<Finger_userinfo_new2>(Finger_userinfo_new2.class));
        }catch(Exception e){
            //createTable(TABLENAME2);
    ...
    //根据主键查询
    public Finger_userinfo_new2 selectByKey(long fu_id) {
        return selectByKey(fu_id, TABLENAME);
    }

    //根据主键查询
    public Finger_userinfo_new2 selectByKey(long fu_id, String TABLENAME2) {
        String sql;
        try{
            sql="SELECT fu_id,fu_nd,ui_tel,ui_id,ui_nd,name,sfz_number,sfz_img_url,sfz_img_back_url,state,is_del,ctime,utime,mac,gather_id,note,fingerprint_state,finger_veno_state FROM "+TABLENAME2+" WHERE fu_id=:fu_id";
            Map<String,Object> param = new HashMap<String,Object>();
            param.put("fu_id", fu_id);
            List<Finger_userinfo_new2> list =  _np.query(sql, param, new BeanPropertyRowMapper<Finger_userinfo_new2>(Finger_userinfo_new2.class));
    ...
    //分页查询
    public List<Finger_userinfo_new2> selectByPage(int begin, int num) {
        return selectByPage(begin, num, TABLENAME);
    }

    //分页查询
    public List<Finger_userinfo_new2> selectByPage(int begin, int num, String TABLENAME2) {
        try{
            String sql;
    ...
    //修改数据
    public int updateByKey(Finger_userinfo_new2 bean) {
        return updateByKey(bean, TABLENAME);
    }

    //修改数据
    public int updateByKey(Finger_userinfo_new2 bean, String TABLENAME2) {
        try{
            String sql;
    ...
    //批量修改数据
    public int[] updateByKey (final List<Finger_userinfo_new2> beans) throws SQLException{
        return updateByKey(beans, TABLENAME);
    }

    //批量修改数据
    public int[] updateByKey (final List<Finger_userinfo_new2> beans, String TABLENAME2) throws SQLException{
        try{
            String sql;
