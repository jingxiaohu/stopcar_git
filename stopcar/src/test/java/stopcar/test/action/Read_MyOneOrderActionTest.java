 ...
 *
 */
public class Read_MyOneOrderActionTest extends BaseActionTest {
	/**
	 ...
	 */
	@Test
	public void my_one_order() throws Exception{
		String url = BaseUrl+"my_one_order.php";
		PostMethod post  = new UTF8PostMethod(url);
		//设置公共参数
		setPublicParam(post);
		
		int type=0;// 获取订单类型  0:普通停车订单  1：租赁停车订单
		String orderid="2017031711511159";//
		
		sign = getSignature(Constants.SYSTEM_KEY, dtype,ui_id,type,orderid);
