 ...
 *
 */
public class ZFB_Pay_FaceActionTest extends BaseActionTest {
	/**
	 * 建行龙支付进行下单接口
	 * @throws Exception
	...
	public void zfb_charge_face() throws Exception{
		 String url = BaseUrl+"zfb_charge_face.php";
		...
		//收银台页面上，商品展示的超链接，必填
		 String show_url ="";
		//页面跳转同步通知页面路径
//		 String return_url = "http://"+ AppProperties.domain+"/v1/notify_zfb.php";
