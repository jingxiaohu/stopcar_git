...
import com.park.pda.action.v1.pda.param.Param_CheckEscapeCar;
...
public class Read_PDA_CheckEscapeCarAction extends BaseV1Controller {
	...
	*/ 
	 ...
	 * @return
	 */
	@RequestMapping(value = "/pda_check_escape_car")
	@ResponseBody
	public String pda_check_escape_car(HttpServletResponse response,Param_CheckEscapeCar param){
		ReturnDataNew returnData = new ReturnDataNew();
		 try{
			...
			orderBiz.pda_check_escape_car(returnData,param.pi_id,param.area_code,param.type,param.car_code);
