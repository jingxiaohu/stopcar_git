...
import com.park.gate.action.v1.park.param.Param_park_carport_log;
import com.park.gate.service.ParkCarportLogBiz;
...
public class Write_park_carport_logAction extends BaseV1Controller {

	private static final long serialVersionUID = -7767400388216597296L;
	
	@Autowired
	protected ParkCarportLogBiz parkCarportLogBiz;
	 ...
	 * @return
	 */
	@RequestMapping(value = "/gate_insert_park_carport_log")
	public String gate_insert_park_carport_log (HttpServletResponse response,Param_park_carport_log param){
		...
		try{
	        ...
	        parkCarportLogBiz.gate_insert_park_carport_log(
	        		returnData,
	        		param.pi_id,
	        		param.area_code, 
	        		param.carport_total,
		      ...
		      log.error("Write_PDA_ParkCarportAction gate_insert_park_carport_log  is error(DEVICE-JAVA)- P", e);
	 ...
	 * @throws Exception
	 */
	private boolean checkParam(Param_park_carport_log param, ReturnDataNew returnData) throws Exception{
		//参数检查
	    if (param == null) {
	      //参数传递错误
